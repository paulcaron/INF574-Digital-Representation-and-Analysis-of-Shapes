...
public class Point_d {
	  ...
	  /** Project on the first 3 coordinates: the result is a 3d in cartesian coordinates */
	  public Point_3 toPoint3D() {
		  if(this.coordinates[this.dimension()-1]==0.)
			  throw new Error("Error: division by 0.");
		  ...
		  return new Point_3(result);
	  }

	  public Point_d toHomogeneous() {
		  throw new Error("method not defined");
	  }

	  public void barycenter(Point_d[] points) {
	  ...
	  public void translateOf(Vector_d v) {
	  ...
	  public Vector_d minus(Point_d b){
		  throw new Error("a' completer");
	  }
